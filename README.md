...
NOTE:: It is assumed you have docker running on your machine At this point the server needs to be set up and launched to proceed. Here are some basic commands to manage the server:
